...
, CONSTRAINT disciplinaOfertadafkIdDisciplina FOREIGN KEY (idDisciplina) REFERENCES disciplina(id)
, CONSTRAINT disciplinaOfertadafkIdProfessor FOREIGN KEY (idProfessor) REFERENCES professor(id)
, CONSTRAINT disciplinaOfertadackAno CHECK (ano BETWEEN 1900 AND 2100)
, CONSTRAINT disciplinaOfertadackSemestre CHECK (semestre BETWEEN 1 AND 2)
, CONSTRAINT disciplinaOfertadackTurma CHECK (turma BETWEEN 'A' AND 'Z')
, CONSTRAINT disciplinaOfertadafkCurso FOREIGN KEY (idCurso) REFERENCES curso (id)
)
